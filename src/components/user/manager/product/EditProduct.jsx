...
const EditProduct = () => {
    ...
    const infoValid = () => {
        return productNameException === '' && productBrandException === '' && descriptionException === '' && costException === '' && marginRateException === '' && itemsLeftException === '';
    }
                    ...
                    <Col style={{overflowY: 'scroll', height: '100vh', paddingBottom: '13vh'}}>
                        ...
                        <div className="d-flex">
                            ...
                            <Form className="custom-form py-3 my-1 w-25" style={{marginBottom: '13vh', height: 'fit-content'}}>
                                ...
                                <Button variant={infoValid() ? 'primary' : 'secondary'} type="button" className="m-3" disabled={!infoValid()} onClick={() => editProductHook()}>
                                    Edit Product
                                </Button>
                            </Form>
