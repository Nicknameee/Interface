    ...
    return (
        <Col className="bg-gradient" style={{
            ...
            <Nav className="flex-column w-100">
                <Nav.Link className="navLink" style={{ fontSize: '30px', color: '#e2e6f1', width: '100%', textAlign: 'center' }} onClick={() => redirectToViewingUsers()}>
                    View Users
                </Nav.Link>
                <Nav.Link className="navLink" style={{ fontSize: '30px', color: '#e2e6f1', width: '100%', textAlign: 'center' }} onClick={() => redirectToAddingUser()}>
                    Add User
                </Nav.Link>
                <Nav.Link className="navLink" style={{ fontSize: '30px', color: '#e2e6f1', width: '100%', textAlign: 'center' }} onClick={() => redirectToViewingOrders()}>
                    View Orders
                </Nav.Link>
                ...
                <Nav.Link className="navLink" style={{ fontSize: '30px', color: '#e2e6f1', width: '100%', textAlign: 'center' }} onClick={() => redirectToAddingCategory()}>
                    Add Category
                </Nav.Link>
                <Nav.Link className="navLink" style={{ fontSize: '30px', color: '#e2e6f1', width: '100%', textAlign: 'center' }} onClick={() => redirectToViewPayments()}>
                    View Payments
                </Nav.Link>
                <Nav.Link className="navLink" style={{ fontSize: '30px', color: '#e2e6f1', width: '100%', textAlign: 'center' }} onClick={() => redirectToViewStatistic()}>
                    View Statistic
                </Nav.Link>
            </Nav>
        </Col>
