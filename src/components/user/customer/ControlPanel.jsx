    ...
    return (
        <Col className="bg-gradient" style={{
            ...
            <Nav className="flex-column w-100">
                <Nav.Link className="navLink" style={{ fontSize: '30px', color: '#e2e6f1', width: '100%', textAlign: 'center' }} onClick={() => redirectToOrderHistory()}>
                    My Orders
                </Nav.Link>
                <Nav.Link className="navLink" style={{ fontSize: '30px', color: '#e2e6f1', width: '100%', textAlign: 'center' }} onClick={() => redirectToWaitingList()}>
                    Waiting List
                </Nav.Link>
